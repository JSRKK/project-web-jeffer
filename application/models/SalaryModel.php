...
class SalaryModel extends CI_Model {
	   ...
	   function __construct() 
        ...
        public function get_salary($userId, $date){
                ...
                $this->db->from('salary');
                $where = "EMP_ID = '$userId' AND SALARY_DATE = '$newMonth' ";
                $this->db->where($where);
                $query = $this->db->get();              
                return $query->result_array(); 
        }    
        
        public function get_hour($userId ,$date){
                ...
                $where = "EMP_ID = '$userId' AND SCHEDULE_DATE >= '$lastMonth' AND SCHEDULE_DATE <= '$date'";
                $this->db->where($where);
                $query = $this->db->get();                        
                return $query->result_array(); 
        } 
